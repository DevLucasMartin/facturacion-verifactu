...
$fact_page_title    = 'Edición de albarán';
$fact_page_subtitle = 'Modificar documento de entrega';
...
<form id="albaranForm" method="POST">
    ...
    <div class="albaran-action-bar">
        <div class="albaran-flow d-flex justify-content-between align-items-center flex-wrap gap-2" style="padding-bottom:0 !important;">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <button type="button" class="btn btn-success fact-btn" onclick="guardarYFacturar()">
