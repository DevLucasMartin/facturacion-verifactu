...
<style>
    .doc-flow { max-width: 1100px; margin: 0 auto; padding-bottom: 90px; }
    .doc-action-bar {
        position: fixed;
...
<div class="doc-action-bar">
    <div class="doc-flow d-flex justify-content-between align-items-center flex-wrap gap-2" style="padding-bottom:0 !important;">
        <div class="lh-sm">
            <span class="text-muted d-block" style="font-size:.7rem;">Selección actual</span>
            <span class="fw-semibold small" id="resumenRecap">No hay facturas seleccionadas.</span>
        </div>
        <div class="d-flex gap-2 flex-wrap">
            ...
            <button type="submit" id="btnCrear"
                class="btn btn-sm btn-success fact-btn" disabled>
