...
<div class="input-group fact-search mb-3">
    ...
    <input type="text" id="productosBuscar" class="form-control fact-form-control"
...
<div class="card fact-card">
    ...
    <div class="card-header fact-card-header d-flex flex-wrap align-items-center gap-2">
        <span><i class="bi bi-box-seam me-2 text-muted"></i>Productos</span>
        <span class="text-muted" style="font-weight:400;font-size:.8rem;" id="productosTotalLabel"></span>
    </div>
